...
namespace Testing
{
    ...
    public class UnitTest1
    {
        ...
        public void Setup()
        {
            ...
            Potrebitel user = new Potrebitel(0, "Joshua", "Wessman", 22, "bird", "ghsed1", "JoshW123@gmail.com", 0);
            ElUsero = user;
        }
        [TestCleanup]
        public void CleanUp()
        ...
        {
            var newuser = new Potrebitel(0, "Joshua", "Wessman", 22, "bird", "ghsed1", "JoshW123@gmail.com", 0);
            context.Update(newuser);

            Assert.AreEqual("Joshua", context.Read(0).Name);
        }
        [TestMethod]
